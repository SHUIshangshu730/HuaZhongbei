...
imgs = [
    ('user_data/图4.png', '目标镜面图案\n(卡通猫)'),
    ('figures/paper_pattern_fig4_cat.png', '纸面变形图案\n$I_P$'),
    ('figures/mirror_sim_fig4_cat.png', '正向仿真恢复\n$I_{\mathrm{sim}}$'),
    (None, '误差热图\n$|I_{\mathrm{sim}}-I_M^*|$'),
]
